...
?>
<form method="get" action="<?php echo fw_e(fw_url('/search')); ?>" class="<?php echo fw_e($formClass); ?>" role="search">
    <label class="visually-hidden" for="<?php echo fw_e($inputId); ?>">Search</label>
    <input type="search" id="<?php echo fw_e($inputId); ?>" name="q" class="search-form__input" value="<?php echo fw_e($queryValue); ?>" placeholder="<?php echo fw_e($placeholder); ?>"<?php echo !empty($required) ? ' required' : ''; ?>>
