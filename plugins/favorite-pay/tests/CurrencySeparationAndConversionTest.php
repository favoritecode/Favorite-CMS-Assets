...
class CurrencySeparationAndConversionTest extends TestCase
{
    ...
    public function testNoProductionHardcodedExchangeRatesExist(): void
    {
        ...
        if (!is_dir($pluginDir . '/src')) {
            $pluginDir = dirname(__DIR__, 4) . '/plugins/favorite-pay';
        }
        $filesToAudit = [
            $pluginDir . '/src/Services/CurrencyService.php',
            $pluginDir . '/src/Providers/LiveExchangeRateProvider.php',
            $pluginDir . '/src/Providers/DatabaseRateProvider.php',
            $pluginDir . '/src/Gateways/Binance/BinancePayGateway.php',
            $pluginDir . '/src/Domain/ConversionSnapshot.php',
            $pluginDir . '/src/Domain/Money.php',
        ];
