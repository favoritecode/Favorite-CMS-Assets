...
class AdminProductController
{
    ...
    /**
     * Process bulk actions for digital products.
     */
    ...
    public function store(Request $request): Response
    {
        ...
        $detailsInput = [
            ...
            'manual_file_size_val'   => $request->post('manual_file_size_val'),
            'manual_file_size_unit'  => (string)$request->post('manual_file_size_unit', 'MB'),
            'manual_file_size'       => (string)$request->post('manual_file_size', ''),
        ];
