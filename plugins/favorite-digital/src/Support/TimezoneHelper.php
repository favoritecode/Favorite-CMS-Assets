...
namespace {
    ...
    if (!function_exists('fdig_format_datetime')) {
        function fdig_format_datetime(mixed $datetime, string $format = 'd M Y, h:i A', ?string $timezone = null): string
        {
            return \FavoriteCMS\Digital\Support\TimezoneHelper::format($datetime, $format, $timezone);
        }
    }

    if (!function_exists('fdig_format_date')) {
        function fdig_format_date(mixed $datetime, string $format = 'd M Y', ?string $timezone = null): string
        {
            return \FavoriteCMS\Digital\Support\TimezoneHelper::formatDate($datetime, $format, $timezone);
        }
    }
}
