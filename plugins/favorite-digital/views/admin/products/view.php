        ...
        <div style="display: flex; flex-direction: column; gap: 20px;">
            ...
            <div style="background: #fff; border: 1px solid #c3c4c7; border-radius: 4px; padding: 20px; box-shadow: 0 1px 1px rgba(0,0,0,0.04);">
                ...
                <?php 
                    ...
                    $fileBytes = (int)($details->file_size ?? $details->file_size_bytes ?? 0);
                ?>
                <?php if ($hasFile || $hasUrl): ?>
                    <table style="width: 100%; border-collapse: collapse; font-size: 13px;">
                        <tr style="border-bottom: 1px solid #f0f0f1;">
                            <td style="padding: 8px 0; color: #646970; width: 140px; font-weight: 500;">Resource Type:</td>
                            <td style="padding: 8px 0; color: #1e1e1e; font-weight: 600;">
                                <?php echo match ($details->resource_type ?? 'file') {
                                    'url'   => 'External Resource URL Only',
                                    'both'  => 'Both (Uploaded File + External URL)',
                                    default => 'Uploaded File Only',
                                }; ?>
                            </td>
                        </tr>
                        <?php if ($hasUrl): ?>
                        <tr style="border-bottom: 1px solid #f0f0f1;">
                            <td style="padding: 8px 0; color: #646970; font-weight: 500;">External URL:</td>
                            <td style="padding: 8px 0; color: #1e1e1e; word-break: break-all;">
                                <a href="<?php echo htmlspecialchars((string)$details->resource_url, ENT_QUOTES, 'UTF-8'); ?>" target="_blank" style="color: #0073aa; text-decoration: underline;">
                                    <?php echo htmlspecialchars((string)$details->resource_url, ENT_QUOTES, 'UTF-8'); ?>
                                </a>
                            </td>
                        </tr>
                        <?php endif; ?>
                        <?php if ($hasFile): ?>
                        <tr style="border-bottom: 1px solid #f0f0f1;">
                            <td style="padding: 8px 0; color: #646970; font-weight: 500;">Original Filename:</td>
                            <td style="padding: 8px 0; color: #1e1e1e; font-weight: 600;">
                        ...
                        <tr style="border-bottom: 1px solid #f0f0f1;">
                            ...
                            <td style="padding: 8px 0; color: #1e1e1e;">
                                <?php if ($fileBytes >= 1073741824): ?>
                                    <?php echo htmlspecialchars(number_format($fileBytes / 1073741824, 2), ENT_QUOTES, 'UTF-8'); ?> GB
                                <?php elseif ($fileBytes >= 1048576): ?>
                                    <?php echo htmlspecialchars(number_format($fileBytes / 1048576, 2), ENT_QUOTES, 'UTF-8'); ?> MB
                                <?php else: ?>
                                    <?php echo htmlspecialchars(number_format($fileBytes / 1024, 2), ENT_QUOTES, 'UTF-8'); ?> KB
                                <?php endif; ?>
                                (<?php echo $fileBytes; ?> bytes)
                            </td>
                        </tr>
                        <?php if ($hasFile): ?>
                        <tr style="border-bottom: 1px solid #f0f0f1;">
            ...
            <div style="background: #fff; border: 1px solid #c3c4c7; border-radius: 4px; padding: 20px; box-shadow: 0 1px 1px rgba(0,0,0,0.04);">
                ...
                <?php if (!empty($product->is_free)): ?>
                    <div style="background: #e7f7ed; border: 1px solid #c3e6cb; border-radius: 4px; padding: 12px; text-align: center; margin-bottom: 12px;">
                        <div style="font-size: 18px; font-weight: 700; color: #155724;">FREE (<?= htmlspecialchars($productSymbol, ENT_QUOTES, 'UTF-8') ?>0.00)</div>
                    ...
                    <table style="width: 100%; border-collapse: collapse; font-size: 13px;">
                        <tr style="border-bottom: 1px solid #f0f0f1;">
                            ...
                            <td style="padding: 8px 0; text-align: right; color: #1e1e1e; font-weight: 600;">
                                <?= htmlspecialchars($productSymbol, ENT_QUOTES, 'UTF-8') ?><?php echo htmlspecialchars(number_format((float)$product->original_price, 2), ENT_QUOTES, 'UTF-8'); ?>
                            </td>
                        </tr>
                        <tr style="border-bottom: 1px solid #f0f0f1;">
