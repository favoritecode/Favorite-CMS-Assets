            ...
            <?php if ($state['state'] === 'owned'): ?>
                <?php if ($type === 'service' && !empty($state['service_status'])): ?>
                    <div class="ownership-banner ownership-banner-owned">
                        ...
                        <?php elseif ($state['service_status'] === 'processing'): ?>
                            Your service is currently being processed by our team.
                        <?php else: ?>
                            Your service order is confirmed and currently pending review/start.
                        <?php endif; ?>
                    </div>
                <?php else: ?>
                    <div class="ownership-banner ownership-banner-owned">
